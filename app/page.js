...
export default function RootPage() {
    ...
    return (
        <div className="container">
           ...
           demos.map((demo)=>(
            <div key={demo.id} >
                <div className="h-40 shadow-md rounded-2xl bg-top bg-cover bg-no-repeat hover:bg-bottom transition-all duration-1000 group mb-3" style={{backgroundImage: `url(${demo.img})`}}>
